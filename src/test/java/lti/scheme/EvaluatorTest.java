...
class EvaluatorTest {
    ...
    Value closure =
        new Evaluator()
            .eval(
                ...
                v -> v);
    assertEquals(
        "Closure[formal=Symbol[name=x], body=Variable[name=Symbol[name=x]], env=#<environment>]",
        closure.toString());
  }
  ...
  void evalConditional() {
    ...
    assertEquals(
        ...
        new Evaluator()
            .eval(
                new Conditional(new Literal(new Bool(true)), new Literal(yes), new Literal(no)),
                null,
                v -> v));
    assertEquals(
        no,
        new Evaluator()
            .eval(
                new Conditional(new Literal(new Bool(false)), new Literal(yes), new Literal(no)),
                null,
                v -> v));
  }
}
