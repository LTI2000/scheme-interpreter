...
- Continuation-passing style enables control flow operations

### Key Files
- `Evaluator.java` - Core evaluation logic with pattern matching
- `Expression.java` - AST node types
- `Value.java` - Runtime value types
- `Continuation.java` - CPS continuation interface
